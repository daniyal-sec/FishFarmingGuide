...
export default function AddFeedStockModal({ isOpen, onClose, onSuccess }) {
    ...
    const totalInvestment = (parseFloat(formData.quantity_kg) || 0) * (parseFloat(formData.costPerKg) || 0);

    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            <div className="absolute inset-0 bg-black/60 backdrop-blur-md" onClick={onClose} />

            <div className="relative w-full max-w-lg bg-white flex flex-col max-h-[90vh] rounded-[24px] shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 shrink-0">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900">Add Feed Stock</h2>
                        <p className="text-xs text-gray-500 font-medium mt-1">Record a new feed purchase</p>
                    </div>
                    ...
                    <div className="p-6 overflow-y-auto flex-1 custom-scrollbar">
                        ...
                        <div className="space-y-5">
                            <div className="space-y-1.5">
                                <label className="text-xs font-bold text-gray-700 uppercase tracking-widest">Feed Type *</label>
                                <select
                                    name="feedType"
                                    value={formData.feedType}
                                    onChange={handleChange}
                                    required
                                    className="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm font-medium outline-none transition-all"
                                >
                            ...
                            {formData.feedType === "Other" && (
                                <div className="space-y-1.5 animate-in fade-in slide-in-from-top-2">
                                    <label className="text-xs font-bold text-gray-700 uppercase tracking-widest">Custom Feed Type *</label>
                                    <input
                                        type="text"
                                        name="customFeedType"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-gray-700 uppercase tracking-widest">Quantity (kg) *</label>
                                    <input
                                        type="number"
                                        name="quantity_kg"
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-gray-700 uppercase tracking-widest">Cost Per kg (PKR) *</label>
                                    <input
                                        type="number"
                                        name="costPerKg"
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-gray-700 uppercase tracking-widest">Date *</label>
                                    <input
                                        type="date"
                                        name="purchaseDate"
                                ...
                                <div className="space-y-1.5">
                                    <label className="text-xs font-bold text-gray-700 uppercase tracking-widest">Supplier (Optional)</label>
                                    <input
                                        type="text"
                                        name="supplier"
                            ...
                            <div className="p-4 bg-blue-50 rounded-xl border border-blue-100 flex justify-between items-center mt-4">
                                <span className="text-xs font-bold text-blue-900 uppercase tracking-widest">Total Investment</span>
